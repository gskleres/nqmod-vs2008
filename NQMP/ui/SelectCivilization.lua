...
function AddRandomCivilizationEntry()
	...
	controlTable.Title:LocalizeAndSetText("TXT_KEY_CIV_OTTOMAN_SHORT_DESC"); --"TXT_KEY_RANDOM_LEADER");
...
function AddCivilizationEntry(traitsQuery, populateUniqueBonuses, civ, leaderType, leaderDescription, leaderPortraitIndex, leaderIconAtlas, scenarioCivID)
	...
	local title = Locale.ConvertTextKey("TXT_KEY_RANDOM_CIV_LEADER", leaderDescription, leaderDescription); --civ.ShortDescription);
