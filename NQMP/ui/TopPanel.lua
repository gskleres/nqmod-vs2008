...
function ScienceTipHandler( control )
	...
	if (Game.IsOption(GameOptionTypes.GAMEOPTION_NO_SCIENCE)) then
		...
		-- begin #NQ_GOLD_TO_SCIENCE_FROM_POLICIES
		-- Science from Gold
		local iScienceFromGold = pPlayer:GetScienceFromGoldTimes100();
		if (iScienceFromGold ~= 0) then
			...
			strText = strText .. Locale.ConvertTextKey("TXT_KEY_TP_SCIENCE_FROM_GOLD", iScienceFromGold / 100);
		end
		-- end #NQ_GOLD_TO_SCIENCE_FROM_POLICIES
