...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(NEW_SCORE_CITY_MULTIPLIER),
	GD_INT_INIT(NEW_SCORE_POPULATION_MULTIPLIER),
	GD_INT_INIT(NEW_SCORE_WONDER_MULTIPLIER),
	GD_INT_INIT(NEW_SCORE_TECH_MULTIPLIER),
	GD_INT_INIT(NEW_SCORE_FUTURE_TECH_MULTIPLIER),
	GD_INT_INIT(NEW_SCORE_POLICY_MULTIPLIER),
	GD_INT_INIT(NEW_SCORE_GREAT_WORK_MULTIPLIER),
	GD_INT_INIT(NEW_SCORE_BELIEF_MULTIPLIER),
#endif
