...
public:
	...
	GD_INT_DEF(AI_CANNOT_SPREAD_RELIGION_TO_HUMANS);
#endif
#ifdef NQM_AI_GIMP_NO_WORLD_WONDERS
	GD_INT_DEF(AI_CANNOT_BUILD_WORLD_WONDERS);
#endif
...
#ifdef NQM_AI_GIMP_NO_RELIGION_SPREAD
	GD_INT_DECL(AI_CANNOT_SPREAD_RELIGION_TO_HUMANS);
#endif
#ifdef NQM_AI_GIMP_NO_WORLD_WONDERS
	GD_INT_DECL(AI_CANNOT_BUILD_WORLD_WONDERS);
#endif
